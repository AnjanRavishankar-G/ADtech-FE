      ...
      <div className="p-5">
        ...
        {isLoading ? (
          ...
          <div className="p-5 ">
            ...
            <div className="p-5">
              {/* Hide the heading */}
              <h1 className={`text-xl font-bold mb-7 text-center hidden`}>Brands</h1>
              
              {/* Hide the entire flex container with the three visualizations */}
              <div className={`hidden flex flex-col md:flex-row flex-wrap justify-start gap-5 bg-[#f8f9fa] dark:bg-[#1e1e1e] rounded-2xl`}>
              </div>
                      ...
                      {displayData.map((portfolio) => (
                        <TableRow key={portfolio.portfolio_id}>
                          <TableCell className="border border-default-300 hover:bg-default-100 transition-colors cursor-pointer p-0">
                            <Link 
                              href={`/campaign?brand=${encodeURIComponent(portfolio.name)}&portfolioId=${encodeURIComponent(portfolio.portfolio_id)}`}
            ...
            <div className="mt-12 flex gap-4 rounded-2xl hidden">
            </div>
            </div>
            <div >
              <Footer/>
