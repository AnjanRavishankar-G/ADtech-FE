...
export default function Sidebar({ selectedTab, setSelectedTab }: SidebarProps) {
  ...
  const getTabClasses = (tabName: string) => {
    const baseClasses = `flex items-center gap-3 w-full hover:text-black ${
      isOpen ? "" : "justify-center"
    }`;
    return `${baseClasses} ${
      selectedTab === tabName ? "text-blue-600 font-semibold" : "text-gray-700"
    }`;
  };
          ...
          <ul className="space-y-6 p-4 mt-16">
            ...
            <li>
              <button
                ...
                className={getTabClasses("keywordPerformance")}
              >
                <GiTargeting size={20} />
            ...
            <li>
              <button
                ...
                className={getTabClasses("NegativeKeyword")}
              >
                <FaKey size={20} />
            ...
            <li>
              <button
                ...
                className={getTabClasses("keywordRecommendation")}
              >
