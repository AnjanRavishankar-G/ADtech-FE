...
const BasicPieChart: React.FC<BasicPieChartProps> = ({
    ...
    return (
        <div className="flex flex-col h-full">
            ...
            <div className="flex-1 flex items-center justify-center mt-[-35px]">
                {" "}
                {/* Changed from -20px */}
                <ApexCharts
            ...
            <div
                className={`px-4 py-2 flex flex-wrap justify-center gap-2 mt-[-30px] ${
            ...
            >
                ...
                {labels?.map((label, index) => (
                    <div key={index} className="flex items-center gap-1">
                        ...
                        ></div>
                        <span className="text-inherit text-base font-medium tracking-normal">
                            {" "}
                            {/* Changed from text-sm and added tracking-normal */}
                            {label}
                        </span>
                    </div>
                ))}
