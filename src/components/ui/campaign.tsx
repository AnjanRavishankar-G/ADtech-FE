        ...
        <Table className="border border-default-100 rounded-lg">
          <TableHeader className="bg-black text-white  top-0 z-10">
            <TableRow>
              ...
              <TableHead className="border border-default-300 text-center">Campaign ID</TableHead>
          ...
          <TableBody className="bg-[#212830] text-white">
            {campaignData.map((campaign) => (
              <TableRow key={campaign.SN} className="text-center">
                ...
                <TableCell className="border border-default-300">{campaign.campaignId}</TableCell>
